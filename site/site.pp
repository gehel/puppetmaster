...
node 'gloin.home.ledcom.ch' {
  ...
  pxe::menu::host { 'C0A80128':
    ...
    append => "initrd=images/coreos/${coreos_version}/amd64/coreos_production_pxe_image.cpio.gz root=/dev/sda1 cloud-config-url=http://pastebin.com/raw.php?i=KPNSF9Xf",
  }
}
